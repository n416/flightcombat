...
async function loadMarkdown(target) {
  try {
    ...
    if (target !== 'plot' && target !== 'character' && target !== 'world' && target !== 'timeline' && target !== 'woodcraft' && target !== 'yomikiri') {
...
function restoreState(target) {
  ...
  siteTitle.textContent = '新規プロジェクト';
  ...
  navContainer.innerHTML = `
      <details class="nav-group">
        ...
        <ul id="nav-links">
          ...
          <li><a href="#" data-target="timeline">年表</a></li>
          <li><a href="#" data-target="woodcraft">用語集・設定資料</a></li>
        </ul>
      </details>
      ...
      <details class="nav-group" ${(target !== 'yomikiri' && target !== 'plot' && target !== 'character' && target !== 'world' && target !== 'timeline' && target !== 'woodcraft') ? 'open' : ''}>
        <summary>本編</summary>
        <ul>
          ${mainNavLinks}
        </ul>
